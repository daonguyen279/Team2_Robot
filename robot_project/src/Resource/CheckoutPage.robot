...
Fill out billing information
                                ...
                                Input Text      
                                Click Element  id=select2-billingProvince-container                                                                                 ${Billing Address Field}         ${Billing Address Value}
                                Select From List by Value    
                                Click Element  id=select2-billingDistrict-container                                                                 ${Billing City Field}            ${billingcity_value}
